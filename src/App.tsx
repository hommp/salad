...
const PRODUCTS: Product[] = [
  ...
  },
  {
    name: "Green Vitality",
    price: "55K",
    description: "Green apple, kiwi, and grapes with mint",
    image:
...
const CATEGORIES: Category[] = [
  ...
  { id: "dessert", name: "Dessert", icon: Flame },
  { id: "new", name: "New Arrival", icon: Sparkles },
  { id: "premium", name: "Premium", icon: Star },
  { id: "healthy", name: "Healthy Choice", icon: Heart },
  { id: "classic", name: "Classic", icon: Fruit },
];
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      ...
      <header className="bg-white shadow-sm fixed w-full top-0 z-50">
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-800">Salad18</span>
          </div>
      ...
      {/* Hero Section */}
      <section className="container mx-auto px-6 pt-32 pb-16 text-center relative overflow-hidden">
        <div
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12 animate-on-scroll">
            ...
            <p className="text-gray-600 max-w-3xl mb-4 mx-auto">
              Salad 18 dimulai sejak tahun 2019. Berawal dari berjualan salad
              buah ke tetangga dan teman terdekat serta Instagram pribadi.
              Bermodalkan resep saus salad turun temurun dari keluarga dan
              pemilihan buah yang fresh, penjualan salad 18 dari rumah pribadi
              pada kala itu mendapat feedback yang baik dari teman dan konsumen.
            </p>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Kemudian dengan meningkatnya peminat Salad 18, maka owner
              memberanikan diri untuk stock product setiap hari dan mendaftarkan
              brand Salad 18 ke dalam aplikasi ojek online (Grab & Gojek).
              Berawal dari rumah dengan kegigihan dan kreativitas maka Salad 18
              dapat berkembang dengan membuka 1 outlet pada Desember 2020 dan
              mengalami kenaikan penjualan yang sangat signifikan hingga terjual
              150-200 cup setiap harinya.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Di FreshBowl, kami berkomitmen untuk menjadikan makanan sehat
                  mudah diakses, lezat, dan nyaman. Kami memilih dengan cermat
                  setiap buah dan menciptakan kombinasi sempurna yang tidak
                  hanya terasa luar biasa tetapi juga memberikan nutrisi penting
                  bagi tubuh Anda.
                </p>
                <p className="text-gray-600">
                  Tim kami yang terdiri dari penggemar makanan berdedikasi
                  bekerja tanpa kenal lelah memastikan bahwa setiap mangkuk
                  memenuhi standar kualitas dan kualitas kami yang tinggi
                  kesegaran.
                </p>
              </div>
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-4">
              <p className="text-gray-600">
                © 2024 FreshBowl. All rights reserved.
              </p>
            </div>
          </div>
        </div>
